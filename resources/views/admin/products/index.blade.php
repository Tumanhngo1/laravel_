        ...
        <table class="table table-striped projects">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="project_progress">
                      <img style="width: 30%" src="{{asset('storage/'. $product->image)}}" alt="{{asset('storage/'.$product->image) }}">
                    </td>
                    ...
                    <td class="project-actions text-right">
                      <div>
                        <a class="btn btn-primary btn-sm" href="{{ route('products.show',$product->slug) }}">
